...
def reservation_chambre():
    
    call(["python","reservation_chambre.py"])

b4 = Button(text='<-',font=("Arial",16),fg='#ffffff',background='#5C4D4D',width=5,command=dashboard)
b4.place(x=0, y=0)

#bouton reservation
b1 = Button(root, text="reservation",fg='#ffffff',width=15,background='#5C4D4D',font=("Arial",16),command=reservation_chambre)
b1.place(x=770, y=200)
